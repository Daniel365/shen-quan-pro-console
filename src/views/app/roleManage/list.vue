...
// utils
import type { RoleFormData, RoleListItem, RoleListParams } from '@/api/app/roleManage/types';
...
const roleFormFields = [
  ...
  {
    key: 'description',
    label: i18nText('form.roleDesc'),
    maxlength: 150,
    placeholder: i18nText('form.enterRoleDesc'),
    rows: 3,
    showWordLimit: true,
...
const roleFormRules = {
  ...
  description: [
    { max: 150, message: i18nText('form.message.roleDesc.maxLength'), trigger: 'blur' },
  ],
  name: [
