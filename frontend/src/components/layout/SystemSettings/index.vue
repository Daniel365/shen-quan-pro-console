...
const layoutOptions: LayoutOption[] = [
  { className: 'left', label: i18nText('systemSetting.leftLayout'), value: LayoutMode.LEFT },
  { className: 'top', label: i18nText('systemSetting.topLayout'), value: LayoutMode.TOP },
  { className: 'mix', label: i18nText('systemSetting.mixLayout'), value: LayoutMode.MIX },
];
...
const handleCopySettings = async () => {
  try {
    ...
    ElMessage.success({
      duration: 3000,
      message: i18nText('systemSetting.copySuccess'),
    });
  } catch {
...
const handleResetSettings = async () => {
  ...
  try {
    ...
    ElMessage.success(i18nText('systemSetting.resetSuccess'));
  } catch {
